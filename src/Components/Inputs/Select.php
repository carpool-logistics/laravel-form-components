...
class Select extends Input
{
    ...
    public function inputClass(): string
    {
        return Arr::toCssClasses([
            'form-select',
            'block w-full pl-3 pr-10 py-2 border-slate-300 sm:text-sm focus:outline-none focus:border-blue-300 focus:ring-4 focus:ring-opacity-50 focus:ring-blue-400',
            $this->getAddonClass(),
